...
if __name__ == '__main__':
    ...
    example_raw_data_path = "/content/drive/MyDrive/Colab Notebooks/Demo3/diabetes_prediction_dataset.csv"
    example_processed_data_path = "/content/drive/MyDrive/Colab Notebooks/Demo3/data/processed/diabetes_processed_data.csv"
